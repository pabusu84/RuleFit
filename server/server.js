...
// 🔒 API Key 보안 검증 미들웨어
// ==========================================
const API_KEY = process.env.API_KEY || "rulefit-secret-key-2026"; // PlayMCP에 입력한 Value값과 동일하게 설정
...
app.get('/tools/get-portfolio', (req, res) => {
    ...
    const processedList = holdings.map(item => {
        ...
        const info = BACKUP_STOCKS[rawCode] || { price: item.avg, divPerShare: 0, currency: "KRW" };
